...
<svg viewBox="0 0 640 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SVM 最大間隔與支持向量示意圖">
  <rect x="0" y="0" width="640" height="340" fill="#ffffff"/>
  <!-- Plot area -->
  <rect x="60" y="30" width="520" height="260" fill="#fafafa" stroke="#e5e7eb"/>
  <!-- Margin band (shaded) -->
  <polygon points="80,260 280,60 420,60 220,260" fill="#fef3c7" opacity="0.5"/>
  <!-- Negative margin boundary (dashed) -->
  <line x1="80" y1="260" x2="280" y2="60" stroke="#6b7280" stroke-width="1.5" stroke-dasharray="5 4"/>
  <!-- Positive margin boundary (dashed) -->
  <line x1="220" y1="260" x2="420" y2="60" stroke="#6b7280" stroke-width="1.5" stroke-dasharray="5 4"/>
  <!-- Decision hyperplane (solid, bold) -->
  <line x1="150" y1="260" x2="350" y2="60" stroke="#111827" stroke-width="2.5"/>
  <!-- Margin width indicator -->
  <line x1="300" y1="155" x2="370" y2="155" stroke="#d97706" stroke-width="1.5" marker-end="url(#marginArrow)" marker-start="url(#marginArrow)"/>
  <defs>
    <marker id="marginArrow" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" fill="#d97706"/></marker>
  </defs>
  <text x="335" y="148" text-anchor="middle" font-size="11" fill="#b45309" font-weight="600">2/‖w‖</text>
  <!-- Negative class (blue squares), non-SV -->
  <g fill="#60a5fa" stroke="#1e40af" stroke-width="1">
    <rect x="100" y="140" width="12" height="12"/>
    <rect x="130" y="100" width="12" height="12"/>
    <rect x="90" y="180" width="12" height="12"/>
    <rect x="70" y="230" width="12" height="12"/>
    <rect x="145" y="220" width="12" height="12"/>
    <rect x="110" y="75" width="12" height="12"/>
  </g>
  <!-- Negative class support vectors (on margin) -->
  <g fill="#2563eb" stroke="#1e3a8a" stroke-width="2.5">
    <rect x="152" y="200" width="14" height="14"/>
    <rect x="220" y="108" width="14" height="14"/>
  </g>
  <!-- Positive class (red triangles), non-SV -->
  <g fill="#fca5a5" stroke="#991b1b" stroke-width="1">
    <polygon points="310,240 322,220 334,240"/>
    <polygon points="380,200 392,180 404,200"/>
    <polygon points="430,160 442,140 454,160"/>
    <polygon points="470,120 482,100 494,120"/>
    <polygon points="350,280 362,260 374,280"/>
    <polygon points="510,90 522,70 534,90"/>
  </g>
  <!-- Positive class support vectors -->
  <g fill="#ef4444" stroke="#7f1d1d" stroke-width="2.5">
    <polygon points="280,260 294,238 308,260"/>
    <polygon points="390,120 404,98 418,120"/>
  </g>
  <!-- Labels -->
  <text x="92" y="60" font-size="12" fill="#1e3a8a" font-weight="600">類別 -1</text>
  <text x="510" y="58" text-anchor="end" font-size="12" fill="#7f1d1d" font-weight="600">類別 +1</text>
  <text x="250" y="52" text-anchor="end" font-size="11" fill="#374151">w·x + b = +1</text>
  <text x="90" y="275" font-size="11" fill="#374151">w·x + b = -1</text>
  <text x="355" y="50" font-size="12" fill="#111827" font-weight="600">w·x + b = 0</text>
  <!-- Legend -->
  <rect x="440" y="260" width="12" height="12" fill="#2563eb" stroke="#1e3a8a" stroke-width="2.5"/>
  <text x="458" y="270" font-size="11" fill="#111827">支持向量 Support Vector</text>
  <rect x="60" y="308" width="520" height="28" fill="none"/>
  <text x="320" y="325" text-anchor="middle" font-size="11" fill="#6b7280">黃色帶狀為間隔 Margin；支持向量恰落在虛線上，決定超平面位置；其餘樣本移除不影響解</text>
</svg>
<figcaption>示意圖：SVM 最大間隔分類器。黑實線為決策超平面，上下虛線為間隔邊界；只有落在邊界上（深色）的「支持向量」決定最終解，其餘樣本即使移除也不影響分類結果。</figcaption>
</figure>
```
...
```svg
<figure class="md-figure">
<svg viewBox="0 0 720 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="核技巧 2D 到 3D 映射示意圖">
  <rect x="0" y="0" width="720" height="340" fill="#ffffff"/>
  <!-- LEFT: 2D input space, ring-shaped data not linearly separable -->
  <g transform="translate(20,30)">
    <rect x="0" y="0" width="300" height="280" fill="#fafafa" stroke="#e5e7eb"/>
    <line x1="150" y1="0" x2="150" y2="280" stroke="#cbd5e1"/>
    <line x1="0" y1="140" x2="300" y2="140" stroke="#cbd5e1"/>
    <!-- Outer ring (red) -->
    <g fill="#ef4444" stroke="#7f1d1d" stroke-width="1">
      <circle cx="150" cy="40" r="5"/><circle cx="220" cy="65" r="5"/><circle cx="260" cy="120" r="5"/>
      <circle cx="265" cy="175" r="5"/><circle cx="230" cy="225" r="5"/><circle cx="160" cy="245" r="5"/>
      <circle cx="90" cy="230" r="5"/><circle cx="45" cy="180" r="5"/><circle cx="35" cy="120" r="5"/>
      <circle cx="60" cy="65" r="5"/><circle cx="105" cy="45" r="5"/>
    </g>
    <!-- Inner cluster (blue) -->
    <g fill="#2563eb" stroke="#1e3a8a" stroke-width="1">
      <circle cx="150" cy="140" r="5"/><circle cx="170" cy="125" r="5"/><circle cx="135" cy="155" r="5"/>
      <circle cx="160" cy="158" r="5"/><circle cx="140" cy="125" r="5"/><circle cx="175" cy="145" r="5"/>
      <circle cx="130" cy="140" r="5"/>
    </g>
    <!-- Label -->
    <text x="150" y="302" text-anchor="middle" font-size="13" fill="#111827" font-weight="600">原始 2D 空間：線性不可分</text>
    <text x="150" y="318" text-anchor="middle" font-size="10" fill="#6b7280">x₁, x₂</text>
  </g>
  <!-- ARROW -->
  <g transform="translate(330,160)">
    <path d="M 0 10 L 50 10" stroke="#374151" stroke-width="2" marker-end="url(#phiArrow)"/>
    <defs>
      <marker id="phiArrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" fill="#374151"/></marker>
    </defs>
    <text x="25" y="0" text-anchor="middle" font-size="14" fill="#111827" font-weight="600">ϕ</text>
    <text x="25" y="30" text-anchor="middle" font-size="10" fill="#6b7280">映射到</text>
    <text x="25" y="44" text-anchor="middle" font-size="10" fill="#6b7280">高維</text>
  </g>
  <!-- RIGHT: 3D feature space after mapping -->
  <g transform="translate(400,30)">
    <rect x="0" y="0" width="300" height="280" fill="#fafafa" stroke="#e5e7eb"/>
    <!-- 3D axes (isometric-ish) -->
    <g stroke="#6b7280" stroke-width="1.2" fill="none">
      <line x1="60" y1="240" x2="260" y2="240"/>
      <line x1="60" y1="240" x2="60" y2="40"/>
      <line x1="60" y1="240" x2="140" y2="180"/>
    </g>
    <text x="265" y="244" font-size="10" fill="#6b7280">x₁²</text>
    <text x="52" y="38" text-anchor="end" font-size="10" fill="#6b7280">x₂²</text>
    <text x="145" y="178" font-size="10" fill="#6b7280">√2·x₁x₂</text>
    <!-- Separating plane (parallelogram, semi-transparent) -->
    <polygon points="70,180 250,180 220,230 40,230" fill="#d1fae5" stroke="#059669" stroke-width="1.5" opacity="0.65"/>
    <text x="245" y="200" font-size="11" fill="#047857" font-weight="600">分隔超平面</text>
    <!-- Outer ring points lift HIGH (large r² in input → far from origin in new space) -->
    <g fill="#ef4444" stroke="#7f1d1d" stroke-width="1">
      <circle cx="100" cy="70" r="5"/><circle cx="130" cy="60" r="5"/><circle cx="170" cy="75" r="5"/>
      <circle cx="200" cy="80" r="5"/><circle cx="90" cy="100" r="5"/><circle cx="150" cy="90" r="5"/>
      <circle cx="210" cy="105" r="5"/><circle cx="115" cy="135" r="5"/><circle cx="180" cy="130" r="5"/>
      <circle cx="230" cy="140" r="5"/><circle cx="85" cy="155" r="5"/>
    </g>
    <!-- Inner cluster lies LOW (small r² → near origin) -->
    <g fill="#2563eb" stroke="#1e3a8a" stroke-width="1">
      <circle cx="110" cy="215" r="5"/><circle cx="125" cy="220" r="5"/><circle cx="140" cy="218" r="5"/>
      <circle cx="115" cy="225" r="5"/><circle cx="130" cy="230" r="5"/><circle cx="100" cy="222" r="5"/>
      <circle cx="118" cy="208" r="5"/>
    </g>
    <text x="150" y="302" text-anchor="middle" font-size="13" fill="#111827" font-weight="600">映射後 3D 空間：線性可分</text>
    <text x="150" y="318" text-anchor="middle" font-size="10" fill="#6b7280">(x₁², x₂², √2·x₁x₂)</text>
  </g>
</svg>
<figcaption>示意圖：核技巧。原始 2D 空間中環形資料（紅色外環 vs 藍色內核）無法用直線分開；經映射 ϕ(x₁,x₂)=(x₁², x₂², √2·x₁x₂) 後，環外點因 r² 較大被「抬高」到 3D 空間上方，與內核群分屬平面兩側，即可用單一超平面切開。實際 SVM 透過 kernel function K(x,y)=ϕ(x)·ϕ(y) 直接計算內積，不需真的做映射。</figcaption>
</figure>
```
